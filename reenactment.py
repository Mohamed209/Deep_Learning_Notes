...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model', default='/content/drive/My Drive/fsgan/weights/v1/ijbc_msrunet_256_2_0_reenactment_v1.pth', metavar='PATH',
                        help='path to face reenactment model')
    parser.add_argument('-pm', '--pose_model', default='/content/drive/My Drive/fsgan/weights/shared/hopenet_robust_alpha1.pth', metavar='PATH',
